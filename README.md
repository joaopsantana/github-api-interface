...
Fork do projeto "Criando um front-end totalmente componentizado na prática com ReactJS" do bootcamp EDUZZ-DIO, mais abaixo temos um print da tela do meu github proveniente da execução do projeto no localhost.
